...
public class AddEmployeeTest extends LogInTest{
	...
	@Test(priority=5,description="AddEmployee Text Validation Test")
	public void oHRMApplicationHomePageAddEmployeeTextValidationTest() throws IOException, InterruptedException
	{
	...
	@Test(priority=6,description="Validating AddEmployee Test")
	public void oHRMApplicationHomePageAddEmployeetValidationTest() throws IOException, InterruptedException
	{
		...
		Thread.sleep(5000);
		java.lang.Runtime.getRuntime().exec("C:\\Users\\HP\\eclipse-workspace\\OrangeHRMApplication\\FileUpload\\PhotoUpload.exe");
		Thread.sleep(5000);
	...
	//{
		...
		driver.navigate().refresh();
		 ...
		 fileOutPut=new FileOutputStream("./src/main/java/com/ApplicationTestResultFiles/AddEmployeeTestResult.xlsx");
			workBook.write(fileOutPut);
